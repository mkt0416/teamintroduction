    ...
    return (
        <div id='machine' className='w-full container mx-auto mt-64 px-4 md:px-8 lg:px-12'>
            <section className='w-full'>
                ...
                <div className='mt-8 flex flex-col md:flex-row justify-between items-center gap-10 lg:gap-32'>
                ...
                <div className='mt-32 flex flex-col md:flex-row-reverse justify-between items-center gap-10 lg:gap-32'>
                    <div className='md:w-1/2'>
                    ...
                    <div className='md:w-1/2'>
                        <Image
                            className='rounded-md w-full h-auto object-cover'
                            src={'/images/machine2.jpg'} width={600} height={500} alt='machine1'
                        />
                    </div>
                </div>
                <div className='mt-32 flex flex-col md:flex-row justify-between items-center gap-10 lg:gap-32'>
                    <div className='md:w-1/2'>
                    ...
                    <div className='md:w-1/2'>
                        <Image
                            className='rounded-md w-full h-auto object-cover'
                            src={'/images/machine3.jpg'} width={600} height={500} alt='machine1'
                        />
                    </div>
                </div>
            </section>
